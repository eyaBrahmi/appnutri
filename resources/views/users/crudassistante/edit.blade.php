...
@section('content')
    ...
    <form action="{{ route('crudassistante.update',$patient->id) }}" method="POST">
        @csrf
        @method('PATCH')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="password" name="password" value="{{ $patient->password }}" class="form-control" placeholder="Password">
                </div>
            </div>
